...
```
# 키서버 추가 : 
$ sudo apt-key adv --keyserver-options http-proxy=http://168.219.61.252:8080/ --keyserver hkp://ha.pool.sks-keyservers.net:80 --recv-key 3113421C365BD9FF1F717815A3895523BAEEB01FA116
$ sudo -E add-apt-repository {ppa:alexx2000/doublecmd}
```

## 3. pip 
```
$ pip install --proxy http://168.219.61.252:port 패키지명 
...
"""
{
    "proxies": {
        "default": {
            "httpProxy": "http://168.219.61.252",
            "httpsProxy": "https://168.219.61.252",
